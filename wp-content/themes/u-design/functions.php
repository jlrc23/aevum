...
function udesign_init_styles() {
	...
	wp_enqueue_style('u-design-style', get_bloginfo('template_url') . "/styles/style1/css/style.css", false, '2.1.0', 'screen');
        ...
        if ( $udesign_responsive ) {
            wp_enqueue_style('u-design-responsive', get_bloginfo('template_url') . '/styles/common-css/responsive.css', false, '2.1.0', 'screen');
        }
...
switch ( $udesign_options['page_title_position'] ) {
    ...
    case 'position2': // Position Title Inside Main Content
        ...
        function udesign_test_home_page ( $is_udesign_home_page ) {
            // If title "Position 2" is selected, remove the title from pages that are set as home pages
            if ( !$is_udesign_home_page ) { 
                return udesign_page_title();
            }
        }
        add_action('udesign_above_page_content', 'udesign_test_home_page');
        break;
...
// Admin area styles...
function udesign_custom_admin_styles() {
   echo '<style type="text/css">
            .wrap .title_line h2 { float: none; }
            .wrap .title_line { height: auto; }
            #setting-error-tgmpa { clear: both; }
         </style>';
}
add_action('admin_head', 'udesign_custom_admin_styles');
