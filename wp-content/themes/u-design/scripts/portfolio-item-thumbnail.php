...
function get_portfolio_item_thumbnail( $num_cols='3', $width='260', $height='160', $do_not_link_adjacent_items = 'no', $echo = true ) {
    ...
    $portfolio_item_thumb_retina = get_post_meta($post->ID, 'portfolio_item_thumb_retina', true);
    $portfolio_item_thumb_crop_align = get_post_meta($post->ID, 'portfolio_item_thumb_crop_align', true);
